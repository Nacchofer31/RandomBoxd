...
sealed interface ResultData<out D, out E : Error> {
    data class Success<out D>(
        val data: D,
    ) : ResultData<D, Nothing>

    data class Error<out E : com.nacchofer31.randomboxd.core.domain.Error>(
        val error: E,
...
fun <T, E : Error> ResultData<T, E>.asEmptyDataResult(): EmptyResult<E> = map { }
